...
We study the bag-of-words and $n$-grams language models under the naive Bayes and likelihood-ratio classifiers, as well as logistic regression applied to tf--idf-weighted feature vectors.
...
In \S\ref{sec:n-grams}, \S\ref{sec:tfidf}, and \S\ref{sec:classifiers}, we discuss the principles of our text representation and classification schemes.
...
\section{\texorpdfstring{$n$-grams}{n-grams}} \label{sec:n-grams}
...
\subsection{\texorpdfstring{$n$-grams details}{n-grams details}}
